...
load_dotenv(os.getenv("DJANGO_ENV_FILE", BASE_DIR / ".env"))
...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-development-only-change-before-production")
...
SERVE_MEDIA_FILES = env_bool("DJANGO_SERVE_MEDIA", False)
